...
import Test from "../Seller/MakeProfile/Quiz/Test/Test";
import Punished from "./Block/Punished";
...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      ...
      {/* {role?.role === "block" && (
        <Link style={{ textDecoration: "none" }} to={`${url}/`}></Link>
      )} */}

      {role?.role === "seller" && (
        <Box>
          <h3 style={{ color: "#05223e" }}>Seller Dashboard</h3>
          <Link style={{ textDecoration: "none" }} to="/">
            <Button>Home</Button>
          </Link>

          <Link style={{ textDecoration: "none" }} to={`${url}/makeProfile`}>
            <Button>Make Seller Profile</Button>
          </Link>
          <Link style={{ textDecoration: "none" }} to={`${url}/sellerProfile`}>
      ...
      {role?.role === "buyer" && (
        <Box>
          <h3 style={{ color: "#05223e" }}>Buyer Dashboard</h3>
          <Link style={{ textDecoration: "none" }} to="/">
            <Button>Home</Button>
          </Link>
          <br></br>
          <Link style={{ textDecoration: "none" }} to={`${url}/addJob`}>
          ...
          <Link
            ...
            to={`${url}/makeBuyerProfile`}
          >
            <Button>Make Profile</Button>
          </Link>
          <Link style={{ textDecoration: "none" }} to={`${url}/BuyerProfile`}>
      ...
      {role?.role === "admin" && (
        <Box>
          <h3 style={{ color: "#05223e" }}>Admin Dashboard</h3>
          <Link style={{ textDecoration: "none" }} to="/">
            <Button>Home</Button>
          </Link>
          <br></br>
          ...
          <br />
          <Link style={{ textDecoration: "none" }} to={`${url}/block`}>
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Switch>
          ...
          <Route path={`${path}/BuyerProfile`}>
            <BuyerProfile></BuyerProfile>
          </Route>
          <Route path={`${path}/sellerProfile`}>
            <SellerProfile></SellerProfile>
          </Route>
          <Route path={`${path}/quizTest`}>
            <Test></Test>
          </Route>
