...
const SellerDetails = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:5000/reviews?sellerId=${sellerId}`)
      .then((res) => res.json())
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
                Please give the review and ratings about seller
              </h5>
              <button
                type="button"
                class="btn-close"
      ...
      >
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">
                Seller <b>{showReviews.length}</b> reviews
              </h5>
              <button
                type="button"
                class="btn-close"
